      ...
      <div className="footer-content">
        <div className="footer-club-subscription">
          ...
          <p className="subscribe-description">
            Enter your email address to recieve our weekly newsletters and stay up-to-date. We will not span your inbox.
          </p>
        ...
        <div>
          ...
          <a href="" className="footer-link-item">our events</a>
          <a href="" className="footer-link-item">our tracks</a>
          <a href="" className="footer-link-item">view our leadership</a>
          </div>
        </div>
        <div className="footer-club-social">
          ...
          <a href="" className="footer-link-item">x</a>
          </div>
        </div>
      </div>
      <div className="footer-copyright">
        <p>&copy; {new Date().getFullYear()} - <a href="https://www.linkedin.com/in/manasegunga/" target='_blank'>Manase Gunga</a>. All rights reserved.</p>
      </div>
    </div>
  )
}
